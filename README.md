...
This project includes code generated by STMicroelectronics and custom logic licensed under similar open or educational use terms. See `LICENSE` if provided by ST.
